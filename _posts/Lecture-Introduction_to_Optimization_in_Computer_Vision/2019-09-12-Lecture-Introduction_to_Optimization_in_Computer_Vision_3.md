...
* Variational Optimization Problems
	...
	* <point>함수의 함수</point>를 목적함수로 정의하고 최적화 문제를 푸는 방식임
		* Calculus of Variation이란 방법으로 품

<br><br>
* Calculus of Variations
	* <point>Functional</point>: 함수의 함수를 의미함. 일반적인 함수는 변수->실수로 매핑해주지만 functional은 <point>함수->실수</point>로 매핑해주는 형식임. 함수의 함수라고 모두 functional이 아니라 <point>함수의 함수면서 실수를 할당</point>해줘야 함.
